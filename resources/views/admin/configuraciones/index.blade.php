...
@section('content')
    <div class="row">
        <h3 style="color:#001226;"><i class="fas fa-edit"></i>Listado de configuraciones</h3>
    </div>
            ...
            <div class="card card-outline card-primary">
                <dv class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{url('admin/configuraciones/create')}}" class="btn btn-primary d-none">
                            Registrar nuevo
                        </a>
                    </div>
                </dv>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a href="{{url('admin/configuraciones/'.$configuracione->id.'/confirm-delete')}}" type="button" class="btn btn-danger btn-sm d-none"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
