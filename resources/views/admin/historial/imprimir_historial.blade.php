...
<body>
    ...
    @php
        $citas = $event;
    @endphp
        @if (!empty($citas['historial']) && $citas['historial']->isNotEmpty())
        <br>
        <div class="content">
            <div class="section">
                <h4>Cita Medica</h4>
                <table class="info-table2">
                    ...
                    <tr>
                        <th>Doctor</th>
                        <td colspan="3">{{ $citas['doctor']['nombres']." ".$citas['doctor']['apellidos'] }}</td>
                        <th>Consultorio</th>
                        <td>{{ $citas['consultorio']['nombre'] }}</td>
                    </tr>
                    @php $fechaCarbon = \Carbon\Carbon::parse($citas['start']);
                        $fechaCarbonFin = \Carbon\Carbon::parse($citas['end']); @endphp
                    <tr>
                        <th>Especialidad</th>
                        <td colspan="3">{{ $citas['doctor']['especialidad'] }}</td>
            ...
            <div class="section">
                ...
                <p class="historial_text">{{ $citas['historial'][0]['signos_vitales'] }}</p>
            </div>

            <div class="section">
                <h4>Diagnostico</h4>
                <p class="historial_text">{{ $citas['historial'][0]['diagnostico'] }}</p>
            </div>

            <div class="section">
                <h4>Tratamiento</h4>
                <p class="historial_text">{{ $citas['historial'][0]['tratamiento'] }}</p>
            </div>
        </div>
        @endif
    @endforeach       
